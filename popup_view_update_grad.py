...
class PopupViewGraduate(tk.Frame):
    """ Popup Window """
    ...
    def _create_widgets(self):
        ...
        self._label = tk.Label(self, text = "Update Graduate Student", justify = tk.LEFT).grid(row=0, columnspan=3 )
        ...
        self.e_supervisor.grid(row=8, column=1)
        self.e_undergrad_degree = tk.Entry(self)
        self.e_undergrad_degree.grid(row=9, column=1)
    ...
    def set_data(self):
        ...
        self.e_supervisor.insert(0, self._student['supervisor'])
        self.e_undergrad_degree.insert(0, self._student['undergraduate_degree'])
    ...
    def get_data(self):
        ...
        data = {"first_name": self.e_first_name.get(), "last_name": self.e_last_name.get(),
                     ...
                     "type": "Graduate", "supervisor": self.e_supervisor.get(),
