...
class AddUndergradPopup(tk.Frame):
    """ Add Popup Window """
    ...
    def _create_widgets(self):
        self._title = tk.Label(self, text='Add Undergraduate Student')
        ...
        self._minor = tk.Label(self, text="Minor").grid(row=9, column=0)
        self._min_cred = tk.Label(self, text="Minimum Credit").grid(row=10, column=0)
        ...
        self.e_minor.grid(row=9, column=1)
        self.e_min_cred = tk.Entry(self)
        self.e_min_cred.grid(row=10, column=1)
    ...
    def get_data(self):
        min_credit = self.e_min_cred.get()
